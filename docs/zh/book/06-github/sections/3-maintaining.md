...
![“Your repositories” 区域.](../../../../images/newrepo.png)

Figure 1. 这是 “Your repositories” 区域.

![“new repository” 下拉列表.](../../../../images/new-repo.png)

Figure 2. 这是 “New repository” 下拉列表.

这会带你到 “new repository” 表单:

![“new repository” 表单。](../../../../images/newrepoform.png)
...
![版本库设置链接.](../../../../images/reposettingslink.png)
...
![版本库合作者.](../../../../images/collaborators.png)
...
![合并请求的邮件通知](../../../../images/maint-01-email.png)
...
还有一些有趣的 URL，像 `.diff` 和 `.patch` ，就像你猜的那样，它们提供
...
![邮件回复](../../../../images/maint-03-email-resp.png)
...
![合并按钮](../../../../images/maint-02-merge.png)
...
这告诉 Git： “连接到 `origin` 这个 remote，下载名字为
...
![合并目标](../../../../images/maint-04-target.png)
...
![提醒](../../../../images/maint-05-mentions.png)
...
![取消订阅](../../../../images/maint-06-unsubscribe.png)
...
![通知中心](../../../../images/maint-07-notifications.png)
...
![通知中心](../../../../images/maint-08-notifications-page.png)
...
举个例子，我们来看一看在 [新的合并请求的邮件通知.](#_email_pr) 中发给
...
![贡献注意事项](../../../../images/maint-09-contrib.png)
...
![默认分支](../../../../images/maint-10-default-branch.png)
...
![移交](../../../../images/maint-11-transfer.png)
