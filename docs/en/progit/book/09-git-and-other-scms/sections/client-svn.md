...
Then, enable all users to change revprops – the easy way is to add a
...
This runs the equivalent of two commands – `git svn init` followed by
...
Note that unlike Git, which requires you to merge upstream work you
